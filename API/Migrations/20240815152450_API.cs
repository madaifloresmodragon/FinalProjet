        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TamanioPromedio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CaracteristicasFisicas = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PredisposicionSalud = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "IsEnabled", "LastName", "UserName" },
                values: new object[] { 1, "admin@gmail.com", "admin", true, "admin", "admin" });
